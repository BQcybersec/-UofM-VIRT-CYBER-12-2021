...
### **Phase1**: "I'd like to Teach the World to `Ping`"
    ...
    -Vulnerabilities
        Without knowing much else I would say that the primary vulnerabilty at this stage is having a lone system on the network that stands out amongst the others, potentially positioning itself a target. 
    ...
    -Mittigation Recomendations
        If this particular IP is needed to stay alive, making sure the system itself is hardened and protected. 
    -Osi Layer
        This would be Layer 3 in the OSI model
...
### **Phase2**: "Some `Syn` for Nothin`"
    ...
    -Osi Layer
        This would be Layer 4 in the OSI model
...
### **Phase3**: "I Feel a `DNS` Change Comin' On"
    ...
    -Vulnerabilities
        -With proof in hand I now believe the system has been comprimised. 
    -Findings of a Hacker
        -Since the office reported the glitch I suspect a hacker has been into the system and modified it as well. 
    -Mittigation Recomendations
    ...
    -OSI Layer
        -This would fall under layer 7 of the OSI model
...
### **Phase4**: "Sh`ARP` Dressed Man"
    ...
    -Steps
        ...
        After the risky click of the day I decided to analyze the file with Wireshark. 
            -Two things stood out to me within the packet capture. 
            ...
            -Suspicious findings within packets
    -Vulnerabilities
    ...
    -Osi Layer
      I would say this hack entails all 7 Layers of the OSI model.   
